...
class App extends React.Component {
  ...
  setColourPreference = event => {
    ...
    colours.forEach((colour, index) => {
      if (colour === val) positions[index] = "active";
    });
    this.setState({
      data: {
        ...this.state.data,
  ...
  setDayLimits = () => {
    if (this.state.data.month !== "TBD") {
      let date = new Date(),
        currentMonth = String(date.getMonth() + 1),
        currentDay = String(date.getDate()),
        currentYear = String(date.getFullYear());
      let selectedYear = this.state.data.year,
        selectedMonth = this.state.data.month;
      var days = ["TBD"],
        x,
        z = currentMonth;
      if (currentMonth < 10) z = "0" + z;
      if (selectedMonth === z && selectedYear === currentYear)
        x = String(Number(currentDay) + 1);
      else x = 1;
      var y =
        new Date(Number(selectedYear), Number(selectedMonth), 0).getDate() + 1;
      for (var i = x; i < y; i++) {
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="row field">
                      ...
                      <div className="col-12 col-md-10">
                        <InputEntry
                          textChanged={this.groomNameChanged}
                          value={this.state.data.groomsname}
                          type="text"
                          name="groomsname"
                    ...
                    <div className="row field">
                      ...
                      <div className="col-12 col-md-10">
                        <InputEntry
                          textChanged={this.brideNameChanged}
                          value={this.state.data.bridesname}
                          type="text"
                          name="bridesname"
                    ...
                    <div className="row field">
                      ...
                      <div className="col-12 col-md-10">
                        <InputEntry
                          textChanged={this.phoneTextChanged}
                    ...
                    <div className="row field">
                      ...
                      <div className="col-12 col-md-10">
                        <InputEntry
                          textChanged={this.emailTextChanged}
                    ...
                    <div className="row field">
                      ...
                      <div className="col-12 col-md-10">
                        <InputEntry
                          textChanged={this.weddingLocationChanged}
                          value={this.state.data.weddinglocation}
                          type="text"
                    ...
                    <div className="row field">
                      ...
                      <div className="col-12 col-md-10">
                        <InputEntry
                          textChanged={this.weddingColourThemeChanged}
                          value={this.state.data.weddingcolourtheme}
                          type="text"
                          name="weddingcolourtheme"
                          placeholder="Wedding Colour Theme"
                        />
                      </div>
                    </div>
                    <div className="row field">
                      ...
                      <div className="col-12 col-md-10">
                        <InputEntry
                          textChanged={this.bridesmaidColourChanged}
                          value={this.state.data.bridesmaiddresscolour}
                          type="text"
                          name="bridesmaiddresscolour"
                    ...
                    <div className="row field">
                      ...
                      <div className="col-12 col-md-10">
                        <InputEntry
                          textChanged={this.numberOfGroomsmenChanged}
                          value={this.state.data.weddingparty}
                          type="number"
                          name="weddingparty"
                          min="1"
                        />
                    ...
                    <div className="row field">
                      ...
                      <div className="col-12 col-md-10">
                        <SelectEntry
                          optionChanged={this.weddingClothChanged}
                          value={this.state.data.weddingcloth}
                          options={["Suit", "Tuxedo"]}
                          name="weddingcloth"
                        />
                      </div>
                    ...
                    <div className="row field">
                      ...
                      <div className="col-12 col-md-10">
                        <SelectEntry
                          optionChanged={this.fabricLineChanged}
                          value={this.state.data.fabricline}
                          name="fabricline"
                          options={[
                            "Associate $475",
                            "Professional $600",
                    ...
                    <div className="row field">
                      ...
                      <div className="col-12 col-md-10">
                        <div className="col-4 date">
                          <SelectEntry
                            optionChanged={this.yearChanged}
                        ...
                        <div className="col-4 date">
                          <SelectEntry
                            optionChanged={this.monthChanged}
                    ...
                    <div className="row field">
                      ...
                      <div className="col-12 col-md-10 preferences">
                        <PreferenceButton
                          buttonClicked={this.setColourPreference}
                          selectState={this.state.preferenceButtonState[0]}
                          label="Black"
                        />
                        <PreferenceButton
                          buttonClicked={this.setColourPreference}
                          selectState={this.state.preferenceButtonState[1]}
                          label="Blue"
                        />
                        <PreferenceButton
                          buttonClicked={this.setColourPreference}
                          selectState={this.state.preferenceButtonState[2]}
                          label="Charcoal"
                        />
                        <PreferenceButton
                          buttonClicked={this.setColourPreference}
                          selectState={this.state.preferenceButtonState[3]}
                          label="Grey"
                        />
                        <PreferenceButton
                          buttonClicked={this.setColourPreference}
                          selectState={this.state.preferenceButtonState[4]}
                          label="Burgundy"
                        />
                        <PreferenceButton
                          buttonClicked={this.setColourPreference}
                          selectState={this.state.preferenceButtonState[5]}
                          label="White/Ivory"
                        />
                        <PreferenceButton
                          buttonClicked={this.setColourPreference}
                          selectState={this.state.preferenceButtonState[6]}
                          label="Patterned"
                        />
                        <PreferenceButton
                          buttonClicked={this.setColourPreference}
                          selectState={this.state.preferenceButtonState[7]}
                          label="Undecided"
                        />
                      </div>
                    </div>
